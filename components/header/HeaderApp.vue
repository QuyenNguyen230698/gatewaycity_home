    ...
    >
      ...
      >
        ...
        >
          <div class="flex gap-3 items-center lg:hidden">
            <label for="menu-drawer-mobile" class="rounded-full w-fit bg-transparent border border-pyramid-gold p-2 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 text-pyramid-gold">
      ...
      <div class="drawer">
        ...
        <div class="drawer-side z-50">
          <label for="menu-drawer-desktop" class="drawer-overlay"></label>
          <div
      ...
      <!-- Drawer Products Mobile -->
      <div class="drawer drawer-end">
        <input
          id="menu-drawer-mobile"
          type="checkbox"
          class="drawer-toggle"
          v-model="isDrawerOpenProductMobile"
        />
        <div class="drawer-content"></div>

        <div class="drawer-side z-50">
          <label for="menu-drawer-mobile" class="drawer-overlay"></label>
          <div
            class="bg-custom-green w-full lg:w-1/3 min-h-screen shadow-2xl overflow-y-auto"
          >
            <ul
            ...
            >
                <li
                  class="flex flex-row justify-between items-center w-full py-4"
                >
                  <NuxtLink aria-label="logo" external to="/" @click="closeDrawerMobile">
                    <NuxtImg
                      quality="75"
                      loading="eager"
                      src="https://res.cloudinary.com/dpcigceaq/image/upload/v1765281506/Media%20Gateway%20City/iiingth1w5eatij5cju0.svg"
...
const isDrawerOpenProductMobile = ref(false);
let lastScrollY = 0;
...
const closeDrawerMobile = () => {
  isDrawerOpenProductMobile.value = false;
};
